# figma-component-map Specification

## Purpose

The `figma-component-map` capability provides a shared mapping (`catalogFigmaMap`) between A2UI catalog component names and their corresponding Figma component keys, names, and property mappings. It is importable in both Node.js (CLI) and browser (Figma Plugin sandbox) environments.
